...
var kartOlustur = function kartOlustur(data) {
  ...
  p.textContent = "".concat(data.ülke, " (").concat(data.ülkeKodu, ")");
  var p1 = document.createElement("p");
  p1.textContent = "Enlem: ".concat(data.enlem, "  Boylam : ").concat(data.boylam);
  var p2 = document.createElement("p");
  p2.textContent = "\u015Eehir: ".concat(data.şehir);
  var p3 = document.createElement("p");
  p3.textContent = "Saat Dilimi: ".concat(data.saatdilimi);
  var p4 = document.createElement("p");
  p4.textContent = "Para Birimi: ".concat(data.parabirimi);
  var p5 = document.createElement("p");
  p5.textContent = "ISP: ".concat(data.isp);
